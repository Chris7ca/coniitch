...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("p", { staticClass: "uk-text-meta" }, [
        _vm._v("Completa la siguiente información por favor.")
      ]),
      _vm._v(" "),
      !_vm.dataLoaded
        ? _c(
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("p", { staticClass: "uk-text-meta" }, [
        _vm._v(
          "En caso de que actualmente te encuentres trabajando, completa la siguiente información."
        )
      ]),
      _vm._v(" "),
      !_vm.dataLoaded
...
window.showAxiosErrorMessage = function (error) {
  ...
  var errorMessage = "<p>\n                            ".concat(lang == 'es' ? 'Algunos datos son incorrectos.' : error.response.data.message, "\n                        </p>");
...
var hidePreloaderPage = new Promise(function (resolve, reject) {
