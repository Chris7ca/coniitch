...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    confirmWork: function confirmWork() {
      ...
      UIkit.modal.confirm('¿Estás seguro que deseas confirmar todos los cambios en tu trabajo? Una vez hecho esto, no podrás modificar la información contenida en él.').then(function () {
