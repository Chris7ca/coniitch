...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/congressman/Work.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/congressman/Work.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************/
...
/* harmony import */ var _helpers_Editor_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../helpers/Editor.vue */ "./resources/js/components/helpers/Editor.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Editor: _helpers_Editor_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
  ...
  data: function data() {
    return {
      ...
      themes: [{
        value: 'Transdiscipline',
        name: 'Transdisciplina'
      }, {
        value: 'Health and Society',
        name: 'Salud y Sociedad'
      }],
      title: '',
      theme: '',
      isFirstAuthor: false,
  ...
  methods: {
    clearInputsCoauthor: function clearInputsCoauthor() {
      this.fullNameCoauthor = '';
      this.adscriptionCoauthor = '';
      this.emailCoauthor = '';
      this.isFirstAuthor = false;
    },
    addCoauthor: function addCoauthor() {
      var existsFirstAuthor = this.coauthors.filter(function (c) {
        return c.is_first_author == true;
      });
      var duplicateFirstAuthor = this.isFirstAuthor && existsFirstAuthor.length == 1;
    ...
    editCoautor: function editCoautor(index) {
    ...
    updateCoauthor: function updateCoauthor() {
      var index = this.indexCoauthor;
    ...
    deleteCoauthor: function deleteCoauthor(index) {
      var _this = this;

      UIkit.modal.confirm('¿Seguro que deseas eliminar a este coautor?').then(function () {
        if (_this.coauthors[index].public_id != '') {
          _this.deleteCoauthors.push(_this.coauthors[index].public_id);
        }

        _this.coauthors.splice(index, 1);
      }, function () {});
    },
    getData: function getData() {
      var existsFirstAuthor = this.coauthors.filter(function (c) {
        return c.first_author == true;
      });
      var public_id = this.work ? this.work.public_id : '';
      var text = this.content != "<p>&nbsp;</p>" ? this.content : '';
      return {
        id: public_id,
        title: this.title,
    ...
    saveWork: function saveWork() {
      ...
      var url = route('app.congressman.announcement.save');
      this.loading = true;
      ...
      axios.post(url, data).then(function (response) {
        ...
        _this2.coauthors = response.data.coauthors ? response.data.coauthors : [];
    ...
    confirmWork: function confirmWork() {
      ...
      var note = this.fullNameCoauthor != '' && this.adscriptionCoauthor != '' && this.emailCoauthor != '' ? 'No ha agregado a un coautor' : '';
      UIkit.modal.confirm("\xBFEst\xE1s seguro que deseas confirmar todos los cambios en tu trabajo? Una vez hecho esto, no podr\xE1s modificar la informaci\xF3n contenida en \xE9l. ".concat(note)).then(function () {
        var url = route('app.congressman.announcement.confirm', {
          id: _this3.work.public_id
        });
        _this3.loading = true;
        _this3.loadingConfirmation = true;
        axios.post(url).then(function (response) {
          _this3.loading = false;
          _this3.loadingConfirmation = false;
    ...
    limitWordsReached: function limitWordsReached(words) {
  ...
  created: function created() {
    ...
    if (this.work) {
      ...
      this.axis = this.work.axis ? this.axes.filter(function (a) {
        return a.value == _this4.work.axis;
      })[0] : '';
      this.type = this.work.type ? this.types.filter(function (t) {
        return t.value == _this4.work.type;
      })[0] : '';
      this.theme = this.work.theme ? this.themes.filter(function (th) {
        return th.value == _this4.work.theme;
      })[0] : '';
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/congressman/Work.vue?vue&type=template&id=4a28b689&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/congressman/Work.vue?vue&type=template&id=4a28b689& ***!
  \*******************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "uk-form-stacked uk-grid uk-margin-large",
      attrs: { "uk-grid": "" }
    },
    [
      _c("div", { staticClass: "uk-margin uk-width-1-2@m" }, [
        ...
        _c("input", {
          ...
          attrs: { type: "text", placeholder: "Campo requerido", required: "" },
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.adscription,
              expression: "adscription"
            }
          ],
          staticClass: "uk-input",
          attrs: { type: "text", placeholder: "Campo requerido", required: "" },
          domProps: { value: _vm.adscription },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.adscription = $event.target.value
            }
          }
        })
      ]),
                  ...
                  [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.fullNameCoauthor,
                            expression: "fullNameCoauthor"
                          }
                        ],
                        staticClass: "uk-input",
                        attrs: { type: "text", placeholder: "Nombre completo" },
                        domProps: { value: _vm.fullNameCoauthor },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.fullNameCoauthor = $event.target.value
                          }
                        }
                      })
                    ]),
                    ...
                    _c("div", { staticClass: "uk-width-1-3@m" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.emailCoauthor,
                            expression: "emailCoauthor"
                          }
                        ],
                        staticClass: "uk-input",
                        attrs: {
                        ...
                        domProps: { value: _vm.emailCoauthor },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.emailCoauthor = $event.target.value
                          }
                        }
                      })
                    ]),
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.adscriptionCoauthor,
                            expression: "adscriptionCoauthor"
                          }
                        ],
                        staticClass: "uk-input",
                        attrs: { type: "text", placeholder: "Adscripción" },
                        domProps: { value: _vm.adscriptionCoauthor },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.adscriptionCoauthor = $event.target.value
                          }
                        }
                      })
                    ]),
                    ...
                    _c(
                      "div",
                      { staticClass: "uk-width-auto uk-margin-small-top" },
                      [
                        _c("label", [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.isFirstAuthor,
                                expression: "isFirstAuthor"
                              }
                            ],
                            staticClass: "uk-checkbox",
                            attrs: { type: "checkbox" },
                            domProps: {
                              checked: Array.isArray(_vm.isFirstAuthor)
                                ? _vm._i(_vm.isFirstAuthor, null) > -1
                                : _vm.isFirstAuthor
                            },
                            on: {
                              change: function($event) {
                                var $$a = _vm.isFirstAuthor,
                                  $$el = $event.target,
                    ...
                    _c(
                      ...
                      { staticClass: "uk-width-auto uk-margin-small-top" },
                      [
                        _vm.modeCoauthors == "create"
                          ? _c(
                              "a",
                              {
                                staticClass: "uk-link-reset",
                                attrs: { role: "button" },
                                on: { click: _vm.addCoauthor }
                              },
                              [_vm._v("Agregar coautor")]
                            )
                          : _c(
                              "a",
                              {
              ...
              _vm.coauthors.length > 0
                ? _c(
                    ...
                    [
                      ...
                      _c(
                        "tbody",
                        _vm._l(_vm.coauthors, function(coauthor, index) {
                          return _c("tr", { key: index }, [
                            _c("td", [_vm._v(_vm._s(coauthor.full_name))]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(coauthor.email))]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(coauthor.adscription))]),
                            _vm._v(" "),
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  coauthor.is_first_author
                                    ? "Autor principal"
                                    : "Coautor"
                                )
                              )
      ...
      _c(
        ...
        [
          ...
          _c("editor", {
            attrs: {
              id: "editor_register_work",
              value: "",
              "count-words": true,
              "limit-words": 300
            },
            on: { "limit-words": _vm.limitWordsReached },
            model: {
              value: _vm.content,
              callback: function($$v) {
                _vm.content = $$v
      ...
      _c("div", { staticClass: "uk-margin" }, [
        ...
        _c(
          ...
          {
            staticClass:
              "uk-button uk-button-primary uk-box-shadow-hover-large uk-width-auto",
            attrs: { disabled: _vm.loading || _vm.work == null },
            on: { click: _vm.confirmWork }
          },
          [
            _vm._v(
              "\n            " +
    ...
    return _c("label", { staticClass: "uk-form-label" }, [
      ...
      _c("span", {
        attrs: {
          "uk-icon": "info",
          "uk-tooltip":
            "Para habilitar la edición especial, solo selecciona el texto."
        }
      })
    ])
  }
...
/***/ "./resources/js/components/congressman/Work.vue":
/*!******************************************************!*\
  !*** ./resources/js/components/congressman/Work.vue ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Work_vue_vue_type_template_id_4a28b689___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Work.vue?vue&type=template&id=4a28b689& */ "./resources/js/components/congressman/Work.vue?vue&type=template&id=4a28b689&");
/* harmony import */ var _Work_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Work.vue?vue&type=script&lang=js& */ "./resources/js/components/congressman/Work.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Work_vue_vue_type_template_id_4a28b689___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Work_vue_vue_type_template_id_4a28b689___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/congressman/Work.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/congressman/Work.vue?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./resources/js/components/congressman/Work.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/congressman/Work.vue?vue&type=template&id=4a28b689&":
/*!*************************************************************************************!*\
  !*** ./resources/js/components/congressman/Work.vue?vue&type=template&id=4a28b689& ***!
  \*************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Work_vue_vue_type_template_id_4a28b689___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./Work.vue?vue&type=template&id=4a28b689& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/congressman/Work.vue?vue&type=template&id=4a28b689&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Work_vue_vue_type_template_id_4a28b689___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Work_vue_vue_type_template_id_4a28b689___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/***/ 3:
/*!********************************************!*\
  !*** multi ./resources/js/announcement.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\coniitch\resources\js\announcement.js */"./resources/js/announcement.js");
