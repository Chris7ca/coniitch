    ...
    * {
    ...
    <div style="line-height:15px;font-size:1px">&#160;</div><!--[if mso]></td></tr></table><![endif]-->
        ...
        <div style="color:#555555;font-family:TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 15px; padding-bottom: 15px;">	
            <div style="font-size:12px;line-height:14px;font-family:TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif;color:#555555;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: right"><em>{{ $date }}</em></p></div>	
        </div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
        ...
        <div style="color:#71777D;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 30px;">	
            <div style="font-size:12px;line-height:18px;color:#71777D;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px"><span style="color: rgb(0, 0, 0); font-size: 14px; line-height: 21px;"><strong>Estimado(a)&#160;<span style="font-size: 14px; line-height: 21px;">{{ $work->registered_user->first_name .' '. $work->registered_user->last_name }}</span></strong></span>.</p>
                ...
                @endif
                <p style="margin: 0;font-size: 12px;line-height: 18px">&#160;</p><p style="margin: 0;font-size: 14px;line-height: 21px"><span style="font-size: 14px; line-height: 21px;">Las observaciones que hicieron a tu trabajo fueron las siguientes:</span></p>
                @foreach ($work->reviews as $review)                    
                    <p style="margin: 0;font-size: 14px;line-height: 21px">&#160;</p><p style="margin: 0;font-size: 14px;line-height: 21px"><em><span style="font-size: 14px; line-height: 21px;">{{ $review->feedback }}</span></em></p>
                @endforeach
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
        ...
        <div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 15px; padding-bottom: 0px;">	
            <div style="font-size:12px;line-height:14px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: right"><strong>Comisión Científica</strong></p></div>	
        </div>
        <!--[if mso]></td></tr></table><![endif]-->
    </div>
        ...
        <div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 0px; padding-bottom: 5px;">	
            <div style="font-size:12px;line-height:14px;text-align:right;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;"><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: right">3<sup>er</sup> Congreso de Investigación Transdisciplinar en Ciencias Humanas 2019</p></div>	
        </div>
        <!--[if mso]></td></tr></table><![endif]-->
    </div>
        ...
        <div style="color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
            <div style="font-size:12px;line-height:14px;color:#555555;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 14px"><br data-mce-bogus="1"></p></div>	
        </div>
        <!--[if mso]></td></tr></table><![endif]-->
    </div>
