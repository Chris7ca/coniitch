        ...
        <main class="uk-background-cover" data-src="{{ asset('images/laptop.jpg') }}" uk-img uk-height-viewport>
            ...
            <div class="gradient-background-left uk-flex uk-flex-middle uk-padding-large uk-light" uk-height-viewport>
                ...
                <article class="uk-width-1-3@xl uk-width-1-2@s">
                    ...
                    <h1>Sección en Matenimiento</h1>
                    <hr class="uk-divider-small">
        
                    <p>Sentimos mucho las molestias que esto pudiera provocar, estamos trabajando para que pronto pueda acceder o registrarse.</p>
    
                    <a href="{{ route('site.index') }}" class="uk-button uk-button-default uk-margin-medium uk-box-shadow-hover-large">Regresar al inicio</a>
