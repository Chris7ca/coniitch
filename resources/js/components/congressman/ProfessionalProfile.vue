<template>
    ...
    <div>
        ...
        <p class="uk-text-meta"><b>NOTA.</b> Este pefil no es requerido, solo en caso de que actualmente se encuentre trabajando, puede completar la siguiente información.</p>
